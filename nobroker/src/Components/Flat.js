...
export default function Flat()  {
    ...
    states.sort();
        ...
        const handleSubmit = (e) => {
            ...
            formData.append('appartmentname', flatdetails.apartmentname);
            formData.append('parking', flatdetails.parking);
            formData.append('area', flatdetails.area);
            formData.append('price', flatdetails.price);
            ...
            if(flatdetails.name&&flatdetails.address&&flatdetails.area&&flatdetails.price&&getcity&&getstate&&(9999999999>flatdetails.mobileno && flatdetails.mobileno>999999999))
            {
            Axios.post('http://localhost:3009/insertflatdetails',formData)
                 .then(res => {
    ...
    <h1>Flat Details</h1></div>
      ...
      <div id="main2">
            ...
            <tr><td className='d'>Enter Mobile No</td><td><input type="number" id="mobileno"
                    ...
                    <tr><td className='d'> Enter Address</td><textarea rows="5" id="address"
                    placeholder="Enter Your Address" name='address'value={flatdetails.address} 
                    onChange={handleChange}></textarea></tr>
                    ...
                    <tr><td className='d'>parking Availabolity</td><td className='d'>Yes 
                    ...
                    <tr><td className='d'>Enter Price of flat</td><td><input type="number" id="price"
                    name='price' value={flatdetails.price} onChange={handleChange}></input></td></tr>
